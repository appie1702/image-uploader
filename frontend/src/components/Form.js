  ...
  return (
    <form className="w-full max-w-8xl flex flex-row items-start justify-evenly mx-auto mt-5 gap-2">
        ...
        <div className="flex flex-col items-center mb-6">
            ...
            <div>
            <textarea onChange={(e)=>setdesc(e.target.value)} rows="3" cols="40" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-600" id="desc" name="desc" value={desc}/>
            </div>
        </div>
        <div className="flex flex-col items-center mb-6">
            <div>
